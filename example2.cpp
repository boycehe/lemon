...
#line 22 "example2.y"
{ 
					 cout << "Result = " << yymsp[0].minor.yy18.value << "\n" <<endl;
					 cout << "Result = " << yymsp[0].minor.yy18.n <<endl;
					}
#line 715 "example2.cpp"
        break;
      case 1: /* expr ::= expr MINUS expr */
#line 27 "example2.y"
{
									 yygotominor.yy18.value = yymsp[-2].minor.yy18.value - yymsp[0].minor.yy18.value;
									 yygotominor.yy18.n = yymsp[-2].minor.yy18.n + 1 + yymsp[0].minor.yy18.n + 1;
									 cout<<"执行减法-->"<<"b:"<<yymsp[-2].minor.yy18.value<<"c:"<<yymsp[0].minor.yy18.value<< "\n"<<endl;
									}
#line 724 "example2.cpp"
        break;
...
{ 
									yygotominor.yy18.value = yymsp[-2].minor.yy18.value + yymsp[0].minor.yy18.value;
									yygotominor.yy18.n = yymsp[-2].minor.yy18.n + 1 + yymsp[0].minor.yy18.n + 1;
									cout<<"执行加法-->"<<"b"<<yymsp[-2].minor.yy18.value<<"c:"<<yymsp[0].minor.yy18.value<< "\n"<<endl;
								  }
#line 733 "example2.cpp"
        break;
...
#line 39 "example2.y"
{
									 yygotominor.yy18.value = yymsp[-2].minor.yy18.value * yymsp[0].minor.yy18.value;
									 yygotominor.yy18.n = yymsp[-2].minor.yy18.n + 1 + yymsp[0].minor.yy18.n + 1;
									 cout<<"执行乘法-->"<<yymsp[-2].minor.yy18.value<<"c:"<<yymsp[0].minor.yy18.value<< "\n"<<endl;
									 }
#line 742 "example2.cpp"
        break;
      case 4: /* expr ::= expr DIVIDE expr */
#line 46 "example2.y"
{ 
	if(yymsp[0].minor.yy18.value != 0){
		yygotominor.yy18.value = yymsp[-2].minor.yy18.value / yymsp[0].minor.yy18.value;
		yygotominor.yy18.n = yymsp[-2].minor.yy18.n + 1 + yymsp[0].minor.yy18.n + 1;
	}else{
...
#line 755 "example2.cpp"
        break;
      case 5: /* expr ::= NUM */
#line 56 "example2.y"
{ 
							yygotominor.yy18.value = yymsp[0].minor.yy0.value;
							yygotominor.yy18.n = yymsp[0].minor.yy0.n + 1;
 						}
#line 763 "example2.cpp"
        break;
      default:
        break;
/********** End reduce actions ************************************************/
